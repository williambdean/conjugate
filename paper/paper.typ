...
- Coverage of conjugate prior-likelihood pairs outlined in statistical literature, particularly Fink's compendium#cite(<fink1997compendium>) and the #link("https://en.wikipedia.org/wiki/Conjugate_prior", "Wikipedia Conjugate Prior page")
- Interactive and educational resources, including an #link("https://williambdean.github.io/conjugate/explorer", "online Distribution Explorer") that enables real-time exploration of prior-posterior relationships without requiring local installation
...
- An intuitive, pipeable API compatible with numpy arrays#cite(<harris2020array>), pandas DataFrames/Series#cite(<The_pandas_development_team_pandas-dev_pandas_Pandas>), polars DataFrames#cite(<polars2024>) (for element-wise operations), and general numerical types
...
- Connection to scipy distributions for interoperability#cite(<virtanen2020scipy>)
- Support for conjugate likelihood-prior pairs listed in statistical literature and Wikipedia
- An #link("https://williambdean.github.io/conjugate/explorer", "interactive Distribution Explorer") and live, documented examples including #link("https://williambdean.github.io/conjugate/examples/bayesian-update", "Bayesian updates"), #link("https://williambdean.github.io/conjugate/examples/thompson", "Thompson sampling"), and #link("https://williambdean.github.io/conjugate/examples/linear-regression", "Bayesian linear regression")
...
likelihood; see
#link("https://williambdean.github.io/conjugate/examples/unsupported-distributions",
"the unsupported distributions example") for a detailed demonstration.

This structure fits naturally within the broader Bayesian
workflow#cite(<gelman2020workflow>): specifying a prior, summarizing data,
...
#link("https://williambdean.github.io/conjugate/models/", "documentation").
...
#link("https://williambdean.github.io/conjugate/examples/bayesian-update",
...
#figure(
  image("../docs/images/binomial-beta.png", width: 80%),
  caption: [Posterior and Posterior Predictive for Binomial-Beta Model.]
)

More backend demonstrations and notebooks are available in the
#link("https://williambdean.github.io/conjugate/examples/vectorized-inputs",
"vectorized inputs example") and the
#link("https://williambdean.github.io/conjugate/explorer", "Distribution
Explorer").
...
#figure(
  image("../docs/images/thompson.png", width: 80%),
  caption: [Posterior samples and action selection for a multi-armed Thompson sampling bandit.]
)
...
Stan/Pystan#cite(<stan2025reference>), scipy.stats#cite(<virtanen2020scipy>),
scikit-learn#cite(<scikit-learn>), ArviZ#cite(<Kumar2019>), and
Bambi#cite(<Capretto_Bambi_A_simple_2022>). These tools provide immense generality but are typically
...
extensive documented examples (such as #link("https://williambdean.github.io/conjugate/examples/bayesian-update", "Bayesian updates") and #link("https://williambdean.github.io/conjugate/examples/binomial", "binomial models"))
demonstrate proper usage patterns. Community support is available through
#link("https://github.com/williambdean/conjugate/issues", "GitHub Issues") and
#link("https://github.com/williambdean/conjugate/discussions", "Discussions").
...
#link("https://github.com/williambdean/conjugate", "https://github.com/williambdean/conjugate").
Community contributions are encouraged through the project's
#link("https://github.com/williambdean/conjugate/blob/main/CONTRIBUTING.md", "CONTRIBUTING.md")
guidelines, and interactive exploration is supported through the
#link("https://williambdean.github.io/conjugate/explorer", "online Distribution Explorer").
